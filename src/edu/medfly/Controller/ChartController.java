...
public class ChartController implements Initializable {
    ...
    com.mysql.jdbc.Connection cnx =MaConnexion.getInstance().getCnx();
...
//     public  ObservableList<PieChart.Data> buildData() {
        ...
        try {
            ...
            String requete = "SELECT nom_produit, COUNT(*) AS nombre_produits FROM produit  GROUP BY nom_produit";
...
//     public  ObservableList<PieChart.Data> buildData() {
        ...
        try {
            ...
            String requete = "SELECT DISTINCT nom, COUNT(nom) AS nbC FROM categorie GROUP BY nom;";
...
//                System.out.println(rs.getInt(2));
    ...
    public XYChart.Series buildDataLineChart() {
        ...
        XYChart.Series d;
        try {
            String requete = "SELECT quantite, COUNT(*) AS quantite_produits FROM produit GROUP BY quantite;";
